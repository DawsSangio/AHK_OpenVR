...
global HID_USAGE_WHL := 0x38
global HID_USAGE_POV := 0x39
...
; image .png or .jpg max 1920x1080
SetOverlayImage(overlay,image)
{
	global Func_SetOverlayImage
	DllCall(Func_SetOverlayImage, "UInt64", overlay, "AStr", image)
}
